...
Updated September 13, 2026. This document describes further research and proposed checks. See IMPLEMENTATION_STATUS.md for implemented tools, validation and limitations. Usage guidance belongs in discoverable tool descriptions. Current sculpt revision protection covers individual targets, and pose previews provide sampled images.

## Outcome and scope

Build an integration that helps an agent deliver finished, editable Blender work across stylized, medium-detail, and high-detail modeling; materials; rigging; animation; and experimental sculpting. Low polygon count is a production constraint, not a measure of artistic quality.
